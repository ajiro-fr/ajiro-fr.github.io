...
tags:
  ...
  - kata
illustration:
  name: 3830209910_f1568d6bc1_o
  source: https://www.flickr.com/photos/korosirego/3830209910/
---
Vous voulez comprendre ou apprendre des compétences en développement produit ? Ce post est le deuxième post d’exercices d’une série de 5.
...
{% include img.html
    name='6816979068_b4d41c5094_k'
    source='https://www.flickr.com/photos/pahudson/6816979068/'
%}

## Episode 3 : Well being north star

### Explication
Vous avez fait une démo à un client ou laissé un client utilisé un prototype. C'est très bien et la question qui vient derrière, c'est "Qu'est ce que vous en faites ?". Et bien rien naturellement. Non je plaisante. L'idée est dans un premier temps de caractériser les retours. Je propose d'utiliser un innovation games pour cela http://www.innovationgames.com/wellbeing-north-star/.
...
- Je considère qu'il n'y a pas eu de validation et qu'il n'y en aura jamais. Je clos le sujet en explicitant les raisons (hypothèse A non validée, ...) et je passe au prochain sujet.
